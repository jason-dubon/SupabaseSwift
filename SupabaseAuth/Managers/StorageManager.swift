...
class StorageManager {
    ...
    private let apikey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml4amZ2Y2RtcW5oZnpkaHBjand2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODM3MjQ2MTksImV4cCI6MTk5OTMwMDYxOX0.JYC-8ibgH6ILDCFozR_dDzlGcPE6v2u1e3WQXza9Ni4"
    
    private let secret = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml4amZ2Y2RtcW5oZnpkaHBjand2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTY4MzcyNDYxOSwiZXhwIjoxOTk5MzAwNjE5fQ.e8EhHSa7KK-2eiiwEHSdu_xKlfudgZ6kkK8aud2PvjI"
    
    lazy var storage = SupabaseStorageClient(url: "https://ixjfvcdmqnhfzdhpcjwv.supabase.co/storage/v1", headers: [
